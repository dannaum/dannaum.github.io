...
function animationsRender() {
  if ($(window).width() > 991) {
    ...
    n.add({
      ...
      anime.timeline({ loop: !1, autoplay: !1 }).add({
      ...
      $(window).scroll(function () {
        if (
          ...
          if (
            ...
            let p = new Chart(document.getElementById("myChart"), config);
            document
              .querySelector("#first-chart")
              .addEventListener("click", function e() {
                p.isDatasetVisible(0),
                  p.isDatasetVisible(1),
                  p.isDatasetVisible(2),
                  p.show(0),
                  p.hide(1),
                  p.hide(2);
              }),
          ...
          $(".chart-timeline").isInViewport()
            ...
            ? $(".single-career-grid-wrap-single").each(function (e) {
                var t = $(this);
                setTimeout(function () {
                  t.click();
                }, 50 * e);
    ...
    function (e) {
      ...
      $.each(e, function (e, s) {
        if (s.jobs.length > 0) {
          ...
          let r = $('<div class="positions_grid-team"></div>');
          $(
...
function dragDetector() {
  ...
  ourTeamsDrag = new Dragdealer("our-team-drag", {
    ...
    vertical: !1,
    xPrecision: s,
    animationCallback: function (n, r) {
      $(".our-teams_drag-line-active").css("width", Math.round(100 * n) + "%"),
        $(".our-teams_slider").css("margin-left", -n * (s * t - e + 32));
    },
  });
  var n = Math.round($("#myChart").outerWidth()),
    r = Math.round($(".chart-timeline_wrap").outerWidth());
  (myChartDrag = new Dragdealer("careers-drag", {
    ...
    animationCallback: function (e, t) {
      $(".careers-chart_drag-line-active").css(
        ...
        $("#myChart").css("margin-left", -e * (n - r)),
        $(".chart-timeline").css("margin-left", -e * (n - r));
    },
  })),
    r + 1 < n
