...
function checkCurrencies() {
  ...
  if ('IN' === getCookie('country-based'))
    for (var t = 0; t < e.length; t++)
      e[t].innerHTML.indexOf('€50,000') > -1 &&
        (e[t].innerHTML = e[t].innerHTML.replace('€50,000', '$60,000')),
        e[t].innerHTML.indexOf('€2 billion') > -1 &&
          (e[t].innerHTML = e[t].innerHTML.replace('€2 billion', '$2 billion'));
}
