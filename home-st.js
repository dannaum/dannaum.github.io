	...
	if (!viewedABTest) {
		if ($('.invest-your-way_section').isInViewport()) {
			...
			if (abTestCookie === 'true') {
				...
				userDate.setDate(userDay + 30);
				document.cookie = 'ab-test=true; Path=/; Expires= ' + userDate + '';
				$('#cashflow-ab_test').fadeIn();
...
$('.cashflow_ab-test_close-button, .cashflow_ab-test_close-button-two, .cashflow_ab-test_close-button-three').click(function (e) {
