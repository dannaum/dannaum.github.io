...
readingBlock.each(function () {
  ...
  if (readingTime.text().indexOf("mins") > -1) {
    readingTime.text(readingTime.text().replace("mins", "Min"));
  }
});
