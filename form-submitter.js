...
$("#phone").on("keydown", function (e) {
	if (e.keyCode != 8 && e.keyCode != 32 && e.keyCode != 43 && (e.keyCode < 48 || e.keyCode > 57)) {
		return false;
	}
});

$("#phone").on("change", function () {
	if ($(this).val().indexOf(countryPrefix) !== 0) {
		$(this).val(countryPrefix + $(this).val());
	}
});
