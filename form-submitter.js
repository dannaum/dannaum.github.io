...
$("#phone").on("change", function () {
	...
	if (countryPrefix == undefined) {
		...
		if (optionValue.indexOf(countryPrefix) > -1) {
		}
		else {
			$(this).val(countryPrefix + optionValue);
		}
	}
});
